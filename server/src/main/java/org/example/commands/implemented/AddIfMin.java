...
public class AddIfMin extends Add {
    ...
    public AddIfMin(CollectionManager collectionManager, HelperInputLabManager input, String[] args, LabWork labWork, Integer ownerId, DatabaseManager databaseManager) {
